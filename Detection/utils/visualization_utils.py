...
def draw_bounding_box_on_image(current_frame_number,image,
  ...
  #if(bottom > ROI_POSITION): # if the vehicle get in ROI area, vehicle predicted_speed predicted_color algorithms are called - 0 is an arbitrary value, for my case it looks very well to set position of ROI line at y pixel 0
  ...
  csv_line = predicted_color + "," + str (predicted_direction) + "," + str(predicted_speed) + "," +  str(top)+ "," +  str(bottom)+ "," +  str(right)+ "," +  str(left)# csv line created
...
def visualize_boxes_and_labels_on_image_array(current_frame_number,image,
  ...
  for box, color in box_to_color_map.items():
    ...
    if (("" in display_str_list[0]) or ("truck" in display_str_list[0]) or ("bus" in display_str_list[0]) or ("motorcycle" in display_str_list[0]) or ("bicycle" in display_str_list[0]) or ("person" in display_str_list[0]) or ("traffic light" in display_str_list[0]) or ("stop sign" in display_str_list[0]) or ("van" in display_str_list[0]) or ("taxi" in display_str_list[0]) or ("ambulance" in display_str_list[0])):
            ...
            csv_line_util = display_str_list[0].split(":")[0].split(" ")[1] + "," + csv_line
            lines.append(csv_line_util)
            if keypoints is not None:
